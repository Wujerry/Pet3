...
declare namespace Matter {
  ...
  export interface IConstraintDefinition {
    ...
    angularStiffness?: number | undefined
  ...
  export class Vertices {
     ...
     * @returns {Vertices} vertices
     */
    static fromPath(path: string): Vector[]
  ...
  export class World extends Composite {
    ...
    static add(
      world: World,
      body: Body | Composite | Constraint | MouseConstraint | Array<Body | Composite | Constraint | MouseConstraint>,
    ): World
...
declare module 'poly-decomp' {
  export function decomp(...args: any[]): any
}
