...
import PetParts from '@/app/pet/parts'
import { RenderType } from './Preview'

export function destroy(render: Matter.Render, runner: Matter.Runner, engine: Matter.Engine) {
  if (!render) return
...
export function run(stageWidth: number, stageHeight: number, element: HTMLDivElement, type: RenderType) {
